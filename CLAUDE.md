...
- **React hydration error #418:** Minified React error #418 appears in console on homepage and contact page. Does not break functionality. Likely caused by ThemeProvider class injection or Zustand store rehydration timing. Needs investigation and fix.
