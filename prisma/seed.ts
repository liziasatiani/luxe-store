...
async function main() {
  ...
  await prisma.coupon.upsert({
    ...
    create: {
      ...
      usageLimit: 100,
      perUserLimit: 1,
      description: "₾135 off beauty orders over ₾530",
      isActive: true,
    },
  });
  ...
  const settings = [
    ...
    { key: "currency",                value: "GEL",                     type: "string"  },
    { key: "currency_symbol",         value: "₾",                       type: "string"  },
    { key: "tax_rate",                value: "18",                      type: "number"  },
    { key: "shipping_free_threshold", value: "200",                     type: "number"  },
    { key: "shipping_flat_rate",      value: "15",                      type: "number"  },
    ...
    { key: "meta_description",        value: "Shop luxury beauty, skincare, cosmetics and premium tech. Free shipping on orders over ₾200.", type: "string" },
