          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <a href="mailto:hello@luxestore.com" className="flex items-start gap-3 group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-surface-700 dark:text-surface-300 group-hover:text-brand-500 transition-colors">hello@luxestore.com</p>
                  </div>
                </a>
