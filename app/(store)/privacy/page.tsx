    ...
    <>
      <div className="k-page-hdr">
        <div className="wrap" style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: 11, color: "var(--chalk3)", marginTop: 8, letterSpacing: "0.08em" }}>Last updated: August 8, 2026</p>
        </div>
      </div>
      ...
      <div style={{ paddingTop: 48, paddingBottom: 96 }}>
        <div className="wrap" style={{ maxWidth: 760 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 36 }}>
            {SECTIONS.map(s => (
              <div key={s.title}>
                <h2 style={{ fontFamily: "var(--serif)", fontSize: 17, fontWeight: 700, color: "var(--chalk)", marginBottom: 10, letterSpacing: "0.02em" }}>{s.title}</h2>
