...
const SECTIONS = [
  ...
  { title: "5. Payment", content: "Payment is due at the time of purchase. We accept major credit cards and process payments securely. By providing payment information, you represent that you are authorized to use the payment method provided." },
  ...
  { title: "9. Governing Law", content: "These Terms shall be governed by and construed in accordance with the laws of Georgia, without regard to its conflict of law provisions." },
  ...
  { title: "11. Contact", content: "For questions about these Terms, contact us at legal@everythingstreet.ge." },
];
    ...
    <>
      <div className="bg-surface-50 dark:bg-surface-900/50 border-b border-surface-100 dark:border-surface-800 py-14">
        <Container className="text-center">
          ...
          <p className="text-surface-500">Last updated: August 5, 2026</p>
        </Container>
      </div>
