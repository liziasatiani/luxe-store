...
const SECTIONS = [
  ...
  { title: "5. Payment", content: "Payment is due at the time of purchase. We accept major credit cards, Apple Pay, and Google Pay, processed securely via Stripe. By providing payment information, you represent that you are authorised to use the payment method provided." },
