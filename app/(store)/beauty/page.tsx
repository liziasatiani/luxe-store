    ...
    <>
      <div className="border-b border-black/8 dark:border-white/8 py-16">
        <Container className="text-center">
          <p className="text-[10px] tracking-[0.28em] uppercase text-black/30 dark:text-white/30 mb-4">{t("collection")}</p>
          <h1 className="font-display text-5xl md:text-6xl text-black dark:text-white font-light mb-4">{tNav("beauty")}</h1>
          <p className="text-sm text-black/40 dark:text-white/40 max-w-md mx-auto">{t("desc")}</p>
        </Container>
      </div>
