...
const COPY = {
  ka: {
    ...
    techTitle: "ახალი\nჯენერა-\nცია",
    techSub: "ყველაფერი\nერთ ქუჩაზე",
    techDesc: "Sony, Statik, Logitech — ყველაფერი ერთ ადგილზე",
    techCta: "ტექნოლოგია →",
    beautyTag: "Beauty",
    beautyTitle: "სილამა-\nზის\nხელოვნება",
    beautySub: "ტექნოლოგია\nდა სილამაზე",
    beautyDesc: "Origins, Drunk Elephant, Sulwhasoo — პრემიუმ კოსმეტიკა",
    beautyCta: "სილამაზე →",
  },
  en: {
    techTag: "Technology",
    techTitle: "Next\nGenera-\ntion",
    techSub: "Everything\non one street",
    techDesc: "Sony, Statik, Logitech — everything in one place",
    techCta: "Shop Tech →",
    beautyTag: "Beauty",
    beautyTitle: "The Art\nof\nBeauty",
    beautySub: "Technology\n& Beauty",
    beautyDesc: "Origins, Drunk Elephant, Sulwhasoo — premium cosmetics",
  ...
  fr: {
    ...
    techTitle: "Prochaine\nGénéra-\ntion",
    techSub: "Tout sur\nune rue",
    techDesc: "Sony, Statik, Logitech — tout en un seul endroit",
    techCta: "Voir Tech →",
    beautyTag: "Beauty",
    beautyTitle: "L'Art\nde la\nBeauté",
    beautySub: "Technologie\net Beauté",
    beautyDesc: "Origins, Drunk Elephant, Sulwhasoo — cosmétiques premium",
  ...
  es: {
    ...
    techTitle: "Próxima\nGenera-\nción",
    techSub: "Todo en\nuna calle",
    techDesc: "Sony, Statik, Logitech — todo en un solo lugar",
    techCta: "Ver Tech →",
    beautyTag: "Beauty",
    beautyTitle: "El Arte\nde la\nBelleza",
    beautySub: "Tecnología\ny Belleza",
    beautyDesc: "Origins, Drunk Elephant, Sulwhasoo — cosméticos premium",
