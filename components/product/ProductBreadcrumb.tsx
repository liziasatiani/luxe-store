...
export function ProductBreadcrumb({ crumbs }: { crumbs: Crumb[] }) {
  return (
    <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: 8, fontSize: 11, color: "var(--chalk2)", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 44 }}>
      {crumbs.map((crumb, i) => (
